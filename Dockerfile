# Streamlit + Pyomo + pounce on Python 3.12 slim.
# Quad tank is a nonlinear optimal control problem (4-state coupled dynamics).
# We use pounce, a Rust reimplementation of IPOPT, via the pyomo-pounce
